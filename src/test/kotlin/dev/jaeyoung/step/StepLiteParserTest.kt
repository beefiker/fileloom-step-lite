...
class StepLiteParserTest {
    ...
    @Test
    fun rejectsFiniteCircleGeometryThatOverflowsBounds() {
        val result = StepLiteParser().parse(OverflowingCircleBoundsStep.byteInputStream())
    ...
    @Test
    fun rejectsUnknownCircleRadiusInsteadOfUsingPlacementReferenceAsRadius() {
        val result = StepLiteParser().parse(UnknownCircleRadiusStep.byteInputStream())
    ...
    @Test
    fun rejectsOmittedPolylinePointPlaceholdersInsteadOfDroppingThem() {
        val result = StepLiteParser().parse(OmittedPolylinePointPlaceholderStep.byteInputStream())
    ...
    @Test
    fun preservesAxisPlacementRefDirectionWhenAxisIsOmitted() {
        val result = StepLiteParser().parse(OmittedAxisPlacementAxisStep.byteInputStream())
        ...
        assertClose(4.0, ellipse.points.minOf { it.y })
        assertClose(16.0, ellipse.points.maxOf { it.y })
        assertEquals(0, document.unsupportedEntityCount)
    }
    ...
    @Test
    fun rejectsOmittedBSplineControlPointPlaceholdersInsteadOfDroppingThem() {
        val result = StepLiteParser().parse(OmittedBSplineControlPointPlaceholderStep.byteInputStream())
    ...
    @Test
    fun rejectsDuplicateExplicitBSplineKnotValuesInsteadOfOverRepeatingDomains() {
        val result = StepLiteParser().parse(DuplicateBSplineKnotsStep.byteInputStream())
    ...
    private companion object {
        ...
        private val OverflowingCircleBoundsStep = """
            ISO-10303-21;
            HEADER;
            FILE_DESCRIPTION(('Fileloom overflowing circle bounds STEP fixture'),'2;1');
            FILE_NAME('overflowing-circle-bounds.stp','2026-05-22',('Fileloom'),('Fileloom'),'','','');
            FILE_SCHEMA(('AUTOMOTIVE_DESIGN'));
            ENDSEC;
            DATA;
            #1=PRODUCT('Overflowing Circle Bounds Fixture','Overflowing Circle Bounds Fixture','',(#2));
            #2=PRODUCT_CONTEXT('',#3,'mechanical');
            #3=APPLICATION_CONTEXT('fileloom step lite');
            #10=CARTESIAN_POINT('',(1E308,0.,0.));
            #11=DIRECTION('',(0.,0.,1.));
            #12=DIRECTION('',(1.,0.,0.));
            #13=AXIS2_PLACEMENT_3D('',#10,#11,#12);
            #20=CIRCLE('',#13,1E308);
        ...
        private val UnknownCircleRadiusStep = """
            ISO-10303-21;
            HEADER;
            FILE_DESCRIPTION(('Fileloom unknown circle radius STEP fixture'),'2;1');
            FILE_NAME('unknown-circle-radius.stp','2026-05-22',('Fileloom'),('Fileloom'),'','','');
            FILE_SCHEMA(('AUTOMOTIVE_DESIGN'));
            ENDSEC;
            DATA;
            #1=PRODUCT('Unknown Circle Radius Fixture','Unknown Circle Radius Fixture','',(#2));
            #2=PRODUCT_CONTEXT('',#3,'mechanical');
            #3=APPLICATION_CONTEXT('fileloom step lite');
            #10=CARTESIAN_POINT('',(0.,0.,0.));
            #11=DIRECTION('',(0.,0.,1.));
        ...
        private val OmittedPolylinePointPlaceholderStep = """
            ISO-10303-21;
            HEADER;
            FILE_DESCRIPTION(('Fileloom omitted polyline point placeholder STEP fixture'),'2;1');
            FILE_NAME('omitted-polyline-point-placeholder.stp','2026-05-22',('Fileloom'),('Fileloom'),'','','');
            FILE_SCHEMA(('AUTOMOTIVE_DESIGN'));
            ENDSEC;
            DATA;
            #1=PRODUCT('Omitted Polyline Point Placeholder Fixture','Omitted Polyline Point Placeholder Fixture','',(#2));
            #2=PRODUCT_CONTEXT('',#3,'mechanical');
            #3=APPLICATION_CONTEXT('fileloom step lite');
            #10=CARTESIAN_POINT('',(0.,0.,0.));
            #12=CARTESIAN_POINT('',(10.,0.,0.));
        ...
        private val OmittedAxisPlacementAxisStep = """
            ISO-10303-21;
            HEADER;
            FILE_DESCRIPTION(('Fileloom omitted axis placement axis STEP fixture'),'2;1');
            FILE_NAME('omitted-axis-placement-axis.stp','2026-05-22',('Fileloom'),('Fileloom'),'','','');
            FILE_SCHEMA(('AUTOMOTIVE_DESIGN'));
            ENDSEC;
            DATA;
            #1=PRODUCT('Omitted Axis Placement Axis Fixture','Omitted Axis Placement Axis Fixture','',(#2));
            #2=PRODUCT_CONTEXT('',#3,'mechanical');
            #3=APPLICATION_CONTEXT('fileloom step lite');
            #10=CARTESIAN_POINT('',(10.,10.,0.));
            #11=DIRECTION('',(0.,1.,0.));
        ...
        private val OmittedBSplineControlPointPlaceholderStep = """
            ISO-10303-21;
            HEADER;
            FILE_DESCRIPTION(('Fileloom omitted B-spline control point placeholder STEP fixture'),'2;1');
            FILE_NAME('omitted-bspline-control-point-placeholder.stp','2026-05-22',('Fileloom'),('Fileloom'),'','','');
            FILE_SCHEMA(('AUTOMOTIVE_DESIGN'));
            ENDSEC;
            DATA;
            #1=PRODUCT('Omitted B-spline Control Point Placeholder Fixture','Omitted B-spline Control Point Placeholder Fixture','',(#2));
            #2=PRODUCT_CONTEXT('',#3,'mechanical');
            #3=APPLICATION_CONTEXT('fileloom step lite');
            #10=CARTESIAN_POINT('',(0.,0.,0.));
            #11=CARTESIAN_POINT('',(5.,10.,0.));
        ...
        private val DuplicateBSplineKnotsStep = """
            ISO-10303-21;
            HEADER;
            FILE_DESCRIPTION(('Fileloom duplicate B-spline knots STEP fixture'),'2;1');
            FILE_NAME('duplicate-bspline-knots.stp','2026-05-22',('Fileloom'),('Fileloom'),'','','');
            FILE_SCHEMA(('AUTOMOTIVE_DESIGN'));
            ENDSEC;
            DATA;
            #1=PRODUCT('Duplicate B-spline Knots Fixture','Duplicate B-spline Knots Fixture','',(#2));
            #2=PRODUCT_CONTEXT('',#3,'mechanical');
            #3=APPLICATION_CONTEXT('fileloom step lite');
            #10=CARTESIAN_POINT('',(0.,0.,0.));
            #11=CARTESIAN_POINT('',(4.,8.,0.));
