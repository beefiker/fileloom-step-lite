...
- Emits unreferenced bounded `POLYLINE`, B-spline, composite, full `CIRCLE`, and full `ELLIPSE` curves for wireframe/geometric-set style STEP exports without `EDGE_CURVE` topology
