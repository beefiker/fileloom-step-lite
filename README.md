...
- Extracts `PRODUCT` name, unit hints, `CARTESIAN_POINT`, `VERTEX_POINT`, complex point/vertex records, `AXIS2_PLACEMENT_3D`, `LINE`, `POLYLINE`, complex line/polyline records, `CIRCLE`, `ELLIPSE`, complex conic records, `B_SPLINE_CURVE_WITH_KNOTS`, complex rational B-spline records, `TRIMMED_CURVE`, `SURFACE_CURVE`, `SEAM_CURVE`, complex curve wrapper records, and `EDGE_CURVE`
