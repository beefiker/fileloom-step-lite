...
- Extracts `PRODUCT` name, unit hints, `CARTESIAN_POINT`, `VERTEX_POINT`, complex point/vertex records, `DIRECTION`, `AXIS2_PLACEMENT_3D`, complex direction/placement records, `LINE`, `POLYLINE`, complex line/polyline records, `CIRCLE`, `ELLIPSE`, `PARABOLA`, `HYPERBOLA`, complex conic records, `B_SPLINE_CURVE_WITH_KNOTS`, complex rational B-spline records, `TRIMMED_CURVE`, `SURFACE_CURVE`, `SEAM_CURVE`, complex curve wrapper records, `EDGE_CURVE`, and complex edge records
- Emits lightweight line, polyline, circle, arc, sampled ellipse, sampled parabola, sampled hyperbola, sampled B-spline, and sampled rational B-spline wireframes with 3D bounds for preview adapters
